    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <div className={styles.bottom}>
          ...
          {footer.showSourceCode && footer.sourceCodeUrl && (
            <a href={footer.sourceCodeUrl} target="_blank" rel="noopener noreferrer" className={styles.sourceLink}>
        ...
        {footer.customText && (
          <p className={styles.customText}>{footer.customText}</p>
        )}
      </div>
    </footer>
  )
